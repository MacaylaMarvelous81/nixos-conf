      ...
      }:
      {
        ...
        xdg.mimeApps = {
          ...
          defaultApplications = {
            ...
            # probably could be done with some pipe function or something
            # not using defaultApplicationPackages because not all mime types of
            # app being used for default
